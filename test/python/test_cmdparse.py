...
"""
    ...
    def test_parse_option(self):
        ...
        action_set: ActionSet = parser.parse(['-d'])
        self.assertEqual(1, len(action_set))
        self.assertEqual(0, len(action_set.first_pass_actions))
        action: Action = action_set.second_pass_action
    ...
    def test_parse_position(self):
        ...
        self.assertEqual((), action.positional)
        self.assertEqual({'dry_run': None}, action.options)
        action_set: ActionSet = parser.parse('test -d'.split())
        self.assertEqual(1, len(action_set))
        self.assertEqual(0, len(action_set.first_pass_actions))
        action: Action = action_set.second_pass_action
        self.assertEqual('test', action.name)
        self.assertEqual((), action.positional)
        self.assertEqual({'dry_run': True}, action.options)
        action_set: ActionSet = parser.parse('prconfig a.txt'.split())
        self.assertEqual(1, len(action_set))
        self.assertEqual(0, len(action_set.first_pass_actions))
        action: Action = action_set.second_pass_action
    ...
    def test_parse_op_pos(self):
        ...
        action_set: ActionSet = parser.parse('results -n 1234'.split())
        self.assertEqual(1, len(action_set))
        self.assertEqual(0, len(action_set.first_pass_actions))
        action: Action = action_set.second_pass_action
        self.assertEqual('results', action.name)
        ...
        action_set: ActionSet = parser.parse('results -n 1234 -d'.split())
        self.assertEqual(1, len(action_set))
        self.assertEqual(0, len(action_set.first_pass_actions))
        action: Action = action_set.second_pass_action
        self.assertEqual('results', action.name)
        ...
        action_set: ActionSet = parser.parse('prconfig b.txt'.split())
        self.assertEqual(1, len(action_set))
        self.assertEqual(0, len(action_set.first_pass_actions))
        action: Action = action_set.second_pass_action
        self.assertEqual('prconfig', action.name)
    ...
    def test_parse_mix(self):
        ...
        action_set: ActionSet = parser.parse('env b.txt -n 14'.split())
        self.assertEqual(1, len(action_set))
        self.assertEqual(0, len(action_set.first_pass_actions))
        action: Action = action_set.second_pass_action
        self.assertEqual('env', action.name)
        ...
        action_set: ActionSet = parser.parse('env b.txt -n 14 -d'.split())
        self.assertEqual(1, len(action_set))
        self.assertEqual(0, len(action_set.first_pass_actions))
        action: Action = action_set.second_pass_action
        self.assertEqual('env', action.name)
        ...
        action_set: ActionSet = parser.parse('env b.txt -d -n 15'.split())
        self.assertEqual(1, len(action_set))
        self.assertEqual(0, len(action_set.first_pass_actions))
        action: Action = action_set.second_pass_action
        self.assertEqual('env', action.name)
        ...
        action_set: ActionSet = parser.parse('env -n 16 b.txt'.split())
        self.assertEqual(1, len(action_set))
        self.assertEqual(0, len(action_set.first_pass_actions))
        action: Action = action_set.second_pass_action
        self.assertEqual('env', action.name)
    ...
    def test_first_pass_complex(self):
        ...
        action_set: ActionSet = parser.parse('env b.txt -c c.conf'.split())
        self.assertEqual(2, len(action_set))
        self.assertEqual(1, len(action_set.first_pass_actions))
